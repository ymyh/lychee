...
/// Events sent in the current frame will be readable in the next frame.
/// </summary>
...
public sealed class Event<T> : IEvent
{
    ...
    /// <summary>
    /// Sends an event. The event will be readable in the next frame.
    /// </summary>
    ...
    /// <summary>
    /// Gets all events that were sent in the previous frame.
    /// </summary>
    /// <returns>Events from the previous frame.</returns>
    ...
    /// This should be called once per frame, typically at the beginning of frame processing.
    /// </summary>
